(asdf:defsystem aoc2025
  ...
  :license "MIT"
  :depends-on ("str" "uiop" "alexandria" "function-cache" "serapeum" "drakma" "arrow-macros" "cl-graph" "lparallel" "magicl" "cl-ansi-text" "cl-heap" "btrie" "disjoint-sets" "aoc-utils" "linear-programming")
  :components ((:file "pkg")
               (:file "01")
               (:file "02")
               (:file "03")
