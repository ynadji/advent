(asdf:defsystem aoc2015
  ...
  :license "MIT"
  :depends-on ("str" "uiop" "alexandria" "function-cache" "serapeum" "drakma" "arrow-macros" "cl-graph" "lparallel" "magicl" "cl-ansi-text" "cl-heap" "btrie" "md5" "com.inuoe.jzon" "array-operations")
  :components ((:file "pkg")
               (:file "utils")
               (:file "01")
               (:file "02")
